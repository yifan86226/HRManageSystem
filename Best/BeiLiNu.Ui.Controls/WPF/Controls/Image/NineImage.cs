...
namespace BeiLiNu.Ui.Controls.WPF.Controls
{
    ...
    public class NineImage : Image
    {
        ...
        DependencyProperty.Register("NineGrid", typeof(Thickness), typeof(NineImage), new FrameworkPropertyMetadata(new Thickness(0), FrameworkPropertyMetadataOptions.AffectsRender));
