...
namespace Best.VWPlatform.Controls.Audio
{
    ...
    /// </summary>
    public class CAcmMp3FrameDecompressor
    {
        ...
        public CAcmMp3FrameDecompressor(WaveFormat sourceFormat)
        {
        ...
        /// </summary>
        ~CAcmMp3FrameDecompressor()
        {
            System.Diagnostics.Debug.Assert(false, "CAcmMp3FrameDecompressor Dispose was not called");
            Dispose();
        }
    }
}
