...
namespace CO_IA.UI.ActivitySummarize
{
    public class operateMethod
    {
        ...
        //获取转换工具路径
        public static string ffmpegtool = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "FFmpeg\\ffmpeg.exe";
        //获取视频的文件夹名
        ...
        //文件图片大小
        public static string sizeOfImg = "100*100";
        //文件大小             ConfigurationManager.AppSettings["heightSize"]
        public static string widthOfFile = "480";
        public static string heightOfFile = "360";
        ...
        public static bool changeVideoType(string fileName, string playFile, string imgFile)
        {
            ...
            //设置执行的参数
            pss.StartInfo.Arguments = " -i " + fileName + " -ab 128 -ar 22050 -qscale 6 -r 29.97 -s " + widthOfFile + "x" + heightOfFile + " " + flv_file;
            ...
            try
            {
                ...
                {
                    File.Copy("D:\\default.gif", imgFile);
                }
